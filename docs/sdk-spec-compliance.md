...
| 6. Middleware                 | `done`     | Behaviour-module middleware supports client-level and function-level registration, ordered lifecycle hooks, event-send hooks, response mutation, context/request access, and memoized step-data mutation.                                  |
