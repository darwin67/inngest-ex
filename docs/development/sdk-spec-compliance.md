...
|-------------------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| 3. Environment Variables      | `planned`  | [SDK Spec Core Protocol Foundation](../plans/001-sdk-spec-core-protocol-foundation.org)                                             | Phase 1 covers required environment variables, mode selection, URL overrides, and configuration precedence.                                      |
| 4.1. HTTP Headers And Signing | `planned`  | [SDK Spec Core Protocol Foundation](../plans/001-sdk-spec-core-protocol-foundation.org)                                             | Phase 1 covers SDK and request-version headers, outbound authorization, and signature coverage. Fallback behavior continues in phase 2.          |
...
| 7. Modes                      | `planned`  | [SDK Spec Core Protocol Foundation](../plans/001-sdk-spec-core-protocol-foundation.org)                                             | Cloud/dev mode selection and precedence.                                                                                                         |
